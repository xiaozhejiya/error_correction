...
export async function switchModel(modelProvider, modelName, providerId = null) {
  const body = { model_provider: modelProvider, model_name: modelName }
  ...
  if (data && data.success) return data
  throw new Error((data && data.error) || '切换模型失败')
}
